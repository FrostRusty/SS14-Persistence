...
## Requirements
All contributions must meet the following requirements. Repeated, intentional, or agregious violation of any of these policies may result in a temporary or permanent ban on contributing to the project.
...
1. **PR Template** - A PR template is available for making new pull requests. All relevant sections of this PR template should be included in any contribution to the project including:
    ...
    * Changelog
    ...
    Some sections may not be necessary (i.e. the media section on a change to a number in the code). Any unnecessary sections may be ommited from the PR. PRs may chose to not use the PR template provided all relevant sections above are included.
